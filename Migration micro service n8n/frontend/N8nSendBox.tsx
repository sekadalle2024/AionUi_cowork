...
const N8nSendBox: React.FC<{
  ...
  return (
    <SendBox
      ...
      onSend={handleSend}
      disabled={sending}
      placeholder="Entrez votre requête pour le workflow n8n (ex: Génère un programme de travail pour l'inventaire de caisse)"
      tools={<DemarrerMenuButton onInsertCommand={handleInsertCommand} disabled={sending} />}
    />
  );
};
