...
/**
 * Migration v15 -> v16: Add 'n8n' to conversations type CHECK constraint
 * Adds support for n8n workflow agent conversations
 */
const migration_v16: IMigration = {
  ...
  up: (db) => {
    ...
    console.log('[Migration v16] Added n8n to conversations type constraint');
  },
  down: (db) => {
    // Rollback: Remove n8n conversations and recreate table without n8n type
    db.exec(`
      DELETE FROM conversations WHERE type = 'n8n';
    ...
    console.log('[Migration v16] Rolled back: Removed n8n from conversations type constraint');
  },
};
