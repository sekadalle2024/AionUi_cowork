  ...
  return (
    <div className="p-24px h-full overflow-auto">
      <Card className="max-w-1200px mx-auto">
        ...
        <Paragraph>
          Execute n8n workflows directly without agent involvement. The microservice backend handles the communication with n8n.
        </Paragraph>

        <div className="mt-24px">
          <TextArea
            placeholder="Enter your request for the n8n workflow (e.g., Generate a work program for cash inventory)"
            value={userMessage}
